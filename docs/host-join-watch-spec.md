# HOST, JOIN, WATCH — Three Meeting Views Implementation
...
This implementation provides a complete three-view meeting system that's both powerful for facilitators and accessible for observers, following the jparty.tv model of public watch URLs and role-based interfaces.
