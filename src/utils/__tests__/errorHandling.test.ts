...
describe('AppError', () => {
  it('should create an error with correct details', () => {
    ...
    expect(error.details.userMessage).toBe(ERROR_MESSAGES.CONNECTION_FAILED.title);
  ...
  it('should create an error with custom message', () => {
    ...
    const error = new AppError(ErrorCode.CONNECTION_FAILED, undefined, customMessage);
...
describe('getErrorDisplayInfo', () => {
  ...
  it('should return default info for regular Error', () => {
    ...
    expect(info.description).toBe('An unexpected error occurred. Please try again.');
