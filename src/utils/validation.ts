...
export const validationRules = {
  ...
  meetingTitle: (): ValidationRule => ({
    ...
    message: 'Enter a valid meeting title'
  })
};

// Validate a value against multiple rules
export const validateValue = (value: string, rules: ValidationRule[]): ValidationResult => {
...
export const validateForm = (fields: Record<string, { value: string; rules: ValidationRule[] }>) => {
