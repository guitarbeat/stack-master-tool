...
export const getRoleFromMode = (mode: MeetingMode): { isFacilitator: boolean; isWatcher: boolean } => {
  switch (mode) {
    case 'host':
...
export const getModeFromRole = (isFacilitator: boolean, isWatcher: boolean): MeetingMode => {
