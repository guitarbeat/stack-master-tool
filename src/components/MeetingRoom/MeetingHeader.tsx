...
export const MeetingHeader = ({ meetingData, participantCount, onLeaveMeeting, additionalBadge }: MeetingHeaderProps) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-lg mb-6 sm:mb-8 dark:bg-zinc-900 dark:border dark:border-zinc-800">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex-1 min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-zinc-100 truncate">{meetingData.title}</h1>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
          <div className="flex items-center text-gray-600 dark:text-zinc-300 text-sm sm:text-base">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <button
              ...
              className="flex-1 sm:flex-none px-3 sm:px-4 py-2 sm:py-2.5 text-sm rounded-lg bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-700 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700 dark:active:bg-zinc-600 min-h-[44px] transition-colors"
