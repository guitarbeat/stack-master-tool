...
interface MeetingSuccessStepProps {
  meetingCode: string
...
function MeetingSuccessStep({ 
  meetingCode, 
  shareableLink, 
  qrCodeUrl, 
  onCopyCode, 
  onStartMeeting 
}: MeetingSuccessStepProps): JSX.Element {
  return (
      ...
      <div className="space-y-6">
        ...
        <div className="text-center">
          ...
          <div className="bg-gray-50 dark:bg-zinc-950 border-2 border-dashed border-gray-300 dark:border-zinc-800 rounded-lg p-6">
            ...
            <button
              onClick={() => onCopyCode(meetingCode)}
        ...
        <div>
          ...
          <div className="flex">
            ...
            />
            <button
              onClick={() => onCopyCode(shareableLink)}
